...
def generate_launch_description():
    ...
    ros2_sim_dir = os.path.join(
        get_package_share_directory('clober_ros2_sim'), 'maps')
    ...
    map_dir = os.path.join(ros2_sim_dir, 'suntech_office')
    map_file = 'suntech_office.yaml'
    ...
    bringup_cmd_group = GroupAction([
        ...
        IncludeLaunchDescription(
            ...
            PythonLaunchDescriptionSource(os.path.join(
                launch_dir, 'clober_localization.launch.py')),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(
                launch_dir, 'clober_navigation.launch.py')),
            launch_arguments={'namespace': namespace,
                              'use_sim_time': use_sim_time,
                              'autostart': autostart,
                              'params_file': params_file,
